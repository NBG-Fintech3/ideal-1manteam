                ...
                <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                    ...
                    <div class="block block-themed animated fadeIn">
                        ...
                        <div class="block-content block-content-full block-content-narrow">
                            ...
                            <form class="js-validation-reminder form-horizontal push-30-t push-50" action="includes/send_password.php" method="post">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12 col-sm-6 col-md-5">
                                        <button class="btn btn-block btn-primary" type="submit"><i class="si si-envelope-open pull-right" name="send"></i> Send Mail</button>
                                    </div>
                                </div>
                            </form>
                            <!-- END Reminder Form -->
