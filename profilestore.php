                                ...
                                <div class="block-content text-center">
                                    <div class="row items-push">
                                        <div class="col-xs-6">
                                            ...
                                            $result = mysqli_query($con,"SELECT sum(cost) FROM market WHERE store_id = '$_SESSION[s_id]'");
                                        ...
                                        <div class="col-xs-6">
                                            <div class="h3 push-5">
                                                <?php
                                            $con=mysqli_connect("localhost","root","","ideal");                                
                                            $result = mysqli_query($con,"SELECT sum(returns) FROM market WHERE store_id = '$_SESSION[s_id]'");
                                            while($row = mysqli_fetch_array($result)){
                                            echo "$row[0]";
                                            }
                                              ?>
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-header side-content bg-white-op">
                            ...
                            <a class="h5 text-white">
                                ...
                                <div  class="block-content block-content-full text-center">
                                    ...
                                    <div class="h4 font-w300 text-muted">Store</div>
                                </div>
                        ...
                        <div class="side-content side-content-full">
                            <ul class="nav-main">
                                ...
                                <li><a href="forma.php"   ><i class="fa fa-building-o"></i><span class="sidebar-mini-hide">Purchases Cash</span></a></li>

                                <li><a href="formacredits.php"   ><i class="fa fa-building-o"></i><span class="sidebar-mini-hide">Purchases Credits</span></a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="block">
                                ...
                                $result = mysqli_query($con,"SELECT * FROM market WHERE store_id = '$_SESSION[s_id]'");
                                while($row = mysqli_fetch_array($result))
                                   {
